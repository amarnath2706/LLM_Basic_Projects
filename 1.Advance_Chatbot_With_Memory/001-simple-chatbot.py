...
print("My favorite place is Switzerland.")
...
response = chatbot.invoke([
    HumanMessage(content="What is my favorite place?")
])

print("\n----------\n")

print("What is my favorite place?")
...
response = chain.invoke("my name is Amar")
